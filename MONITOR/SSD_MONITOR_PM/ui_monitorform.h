...
"}"));
        ...
        label11->setGeometry(QRect(240, 330, 56, 20));
        ...
        label_2 = new QLabel(MonitorForm);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setEnabled(true);
        label_2->setGeometry(QRect(240, 360, 141, 17));
        label_2->setProperty("name", QVariant(QByteArray("textLabel1_2_2_3_2_2_2_2_2")));
        txtWrittenBlockCount = new QLineEdit(MonitorForm);
        txtWrittenBlockCount->setObjectName(QStringLiteral("txtWrittenBlockCount"));
        txtWrittenBlockCount->setGeometry(QRect(390, 360, 89, 22));
        txtWrittenBlockCount->setAlignment(Qt::AlignRight);
        txtWrittenBlockCount->setProperty("name", QVariant(QByteArray("txtWrittenBlockCount")));
        ...
        label->raise();
        label->raise();
        txtWrittenPage->raise();
        txtWrittenBlockCount->raise();
        txtDebug->raise();
        label->raise();
        txtTime->raise();
        label->raise();
    ...
    void retranslateUi(QDialog *MonitorForm)
    {
        ...
        label11->setText(QApplication::translate("MonitorForm", "SSD Util", 0));
        ...
        label_2->setText(QApplication::translate("MonitorForm", "Written Block Count", 0));
        txtWrittenBlockCount->setText(QApplication::translate("MonitorForm", "0", 0));
